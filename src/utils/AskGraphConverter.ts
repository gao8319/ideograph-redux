...
import { PrimitiveTypeName } from "../store/common/data";
import { EdgeDirection } from "../store/common/graph";
import { CommonModel } from "../store/common/model";
import { AskGraph } from "./AskGraph";

export const convertAskGraphOntModel = (ontModel: AskGraph.RootModel) => {
    ...
    const model = new CommonModel.Root(
        ...
        edgeGroups.HAS_RELATION_CONCEPT.filter(
